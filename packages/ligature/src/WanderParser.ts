...
// let rec readNetwork: array<Ligature.triple<'v>> => option<Ligature.network<'v>> = triples => {
//   switch readIgnoreWS() {
//   | Null | Undefined => None
...
// and readValue: unit => option<Ligature.value<'v>> = () => {
//   switch readIgnoreWS() {
//   | Null => None
...
// and readQuote: unit => array<Ligature.wanderAtom<'v>> = () => {
