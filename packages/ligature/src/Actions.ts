...
export const stdActions = Map<Element, Action>()
...
//     (networks, stack) => {
//       switch stack {
//       | list{Ligature.Network(left), Ligature.Network(right), ...tail} =>
//         let newNetwork = Ligature.Network([...left, ...right])
//         Ok(networks, list{newNetwork, ...tail})
//       | _ => Error("union requires two networks on top of the stack.")
//       }
//     },
//   ),
// ])
